...
{
    [Serializable]
    public class Violin : Instrumento , IBarnizable, ICuerdas, IAfinable, ITerminado
    {
        #region Atributes
        ...
        public Violin(string luthier, DateTime fecha) : base(luthier, fecha)
        {
            this.tipoInstrumento = eTipoInstrumento.Violin;
        }
